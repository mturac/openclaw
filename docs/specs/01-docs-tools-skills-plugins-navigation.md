...
- `pnpm docs:check-mdx`: passed, 637 files.
- `pnpm docs:check-links`: passed, `checked_internal_links=4301`,
  `broken_links=0`.
- `pnpm docs:check-i18n-glossary`: passed.
- `pnpm lint:docs`: blocked locally by ignored
  `docs/internal/research/2026-05-08-research-agent-payment-card.md`
  markdownlint errors outside this git diff.
- Targeted markdownlint for
  `docs/specs/01-docs-tools-skills-plugins-navigation.md`: passed, 0 errors.
